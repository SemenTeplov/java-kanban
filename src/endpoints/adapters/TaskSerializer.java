...
public class TaskSerializer implements JsonSerializer<AbstractTask> {

    @Override
    public JsonElement serialize(AbstractTask task, Type type, JsonSerializationContext jsonSerializationContext) {
