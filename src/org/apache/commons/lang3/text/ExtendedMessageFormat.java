...
/**
 * Extends {@link MessageFormat} to allow pluggable/additional formatting
 * options for embedded format elements.  Client code should specify a registry
 * of {@link FormatFactory} instances associated with {@link String}
 * format names.  This registry will be consulted when the format elements are
 * parsed from the message pattern.  In this way custom patterns can be specified,
 * and the formats supported by {@link MessageFormat} can be overridden
 ...
 * in the manner of {@link MessageFormat}.  If <em>format-name</em> denotes
 ...
 * </p>
 *
 * <p>Limitations inherited from {@link MessageFormat}:</p>
 * <ul>
