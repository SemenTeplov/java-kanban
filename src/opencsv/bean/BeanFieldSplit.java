...
import opencsv.exceptions.CsvBeanIntrospectionException;
import opencsv.exceptions.CsvConstraintViolationException;
...
public class BeanFieldSplit<T, I> extends AbstractBeanField<T, I> {
     ...
     * conversion.
     * 
     * @see ConverterPrimitiveTypes#convertToRead(String)
     * @see ConverterDate#convertToRead(String)
