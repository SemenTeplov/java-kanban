...
import opencsv.enums.CSVReaderNullFieldIndicator;
...
public class CsvToBeanBuilder<T> {
   ...
   /** @see CSVParser#nullFieldIndicator */
   ...
   /** @see CSVReader#verifyReader */
   private Boolean verifyReader = null;
   
   /** @see CSVParser#separator */
   private Character separator = null;
   
   /** @see CSVParser#quotechar */
   private Character quoteChar = null;
   
   /** @see CSVParser#escape */
   private Character escapeChar = null;

    /**
     * @see CSVParser#strictQuotes
     */
    private Boolean strictQuotes = null;

    /**
     * @see CSVParser#ignoreLeadingWhiteSpace
     */
    private Boolean ignoreLeadingWhiteSpace = null;

    /**
     * @see CSVParser#ignoreQuotations
     */
   ...
   public CsvToBeanBuilder(Reader reader) {
    ...
    /**
     * @see CsvToBean#setMappingStrategy(MappingStrategy)
    ...
    /**
     * @see CsvToBean#setFilter(CsvToBeanFilter)
     ...
     * Ignored if {@link #withMappingStrategy(MappingStrategy)}
     * is called.
     ...
     * @return {@code this}
     * @see CsvToBean#setErrorLocale(Locale)
     * @since 4.0
     */
