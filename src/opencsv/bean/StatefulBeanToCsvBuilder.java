...
public class StatefulBeanToCsvBuilder<T> {
     ...
     *   {@link StatefulBeanToCsv#getCapturedExceptions() }.
     * @return this
     */
     ...
     *   is used.
     * @return this
     * @see StatefulBeanToCsv#setErrorLocale(Locale)
     * @since 4.0
     */
     ...
     * @return this
     * @see CSVWriter#writeNext(String[], boolean)
     * @since 4.2
     */
