...
import opencsv.ICSVWriter;
import opencsv.bean.concurrent.BeanExecutor;
import opencsv.bean.concurrent.ProcessCsvBean;
import opencsv.bean.exceptionhandler.CsvExceptionHandler;
import opencsv.bean.exceptionhandler.ExceptionHandlerThrow;
import opencsv.bean.util.OpencsvUtils;
import opencsv.bean.util.OrderedObject;
import opencsv.exceptions.CsvDataTypeMismatchException;
import opencsv.exceptions.CsvException;
import opencsv.exceptions.CsvRequiredFieldEmptyException;
import opencsv.exceptions.CsvRuntimeException;
...
/**
 * This class writes beans out in CSV format to a {@link Writer},
 ...
 * @see OpencsvUtils#determineMappingStrategy(Class, Locale, String)
 * @since 3.9
 */
public class StatefulBeanToCsv<T> {
     ...
     * @param writer           A {@link Writer} for writing the beans as a CSV to
    ...
    /**
     * Constructor used to allow building of a {@link StatefulBeanToCsv}
     * with a user-supplied {@link ICSVWriter} class.
     *
     * @param mappingStrategy  The mapping strategy to use when writing a CSV file
     * @param exceptionHandler Determines the exception handling behavior
     * @param applyQuotesToAll Whether all output fields should be quoted
     * @param csvWriter        An user-supplied {@link ICSVWriter} for writing beans to a CSV output
     * @param ignoredFields The fields to ignore during processing. May be {@code null}.
     * @param profile The profile to use when configuring how to interpret bean fields
     */
    ...
    /**
     * Writes a bean out to the {@link Writer} provided to the
     * constructor.
     *
    ...
    /**
     * Writes a list of beans out to the {@link Writer} provided to the
     * constructor.
     *
    ...
    /**
     * Writes an iterator of beans out to the {@link Writer} provided to the
     * constructor.
     *
    ...
    /**
     * Writes a stream of beans out to the {@link Writer} provided to the
     * constructor.
     *
     ...
     * {@link #write(List)} or {@link #write(Object)}
