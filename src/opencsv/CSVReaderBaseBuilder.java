...
import opencsv.processor.RowProcessor;
import opencsv.validators.LineValidator;
import opencsv.validators.LineValidatorAggregator;
import opencsv.validators.RowValidator;
import opencsv.validators.RowValidatorAggregator;
...
abstract public class CSVReaderBaseBuilder<T> {
    ...
    /**
     * @return The {@link LineValidatorAggregator} for custom defined {@link LineValidator}s.
     */
    ...
    /**
     * @return The {@link RowValidatorAggregator} for the custom defined {@link RowValidator}s.
     */
